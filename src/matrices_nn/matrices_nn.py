import numpy as np
import data as dt  # Assuming 'data' module contains some necessary data, like maxCost and outputDict
...
class NeuralNetwork:
    ...
    def predvsreal(self, inputs: np.ndarray, labels: np.ndarray):
        """
        Compares the predicted labels with the true labels.
